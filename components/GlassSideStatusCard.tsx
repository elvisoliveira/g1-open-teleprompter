...
interface GlassSideStatusCardProps {
    side: 'left' | 'right';
    connected: boolean;
    glassSideStatus?: DeviceStatus;
    isCompact?: boolean;
}

const GlassSideStatusCard: React.FC<GlassSideStatusCardProps> = ({
    side,
    connected,
    glassSideStatus,
    isCompact = false
...
export default GlassSideStatusCard;